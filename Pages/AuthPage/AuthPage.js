...
import { GrUniverse } from "react-icons/gr";
                                                ...
                                                db.collection(Consts.USERS)
                                                  ...
                                                  .then(() => {
                                                    if(_isMounted?.current){
                                                      ...
                                                      timeouts.current = setTimeout(() => {
                                                        notify(
                                                          "Welcome to Universe. Start by adding posts to your account."
                                                        );
                                                        setLoading(false);
                                                        props.history.push("/");
                                                      }, 150);
                    ...
                    .then(() => {
                      if(_isMounted?.current){
                        timeouts.current = setTimeout(() => {
                          ...
                          context.notify(
                            `Welcome to Universe${given_name && ", " +given_name}. Start by adding posts to your account.`
                          );
                          props.history.push("/");
                        }, 150);
                      }
                    ...
                    .then(() => {
                      if(_isMounted?.current){
                        timeouts.current = setTimeout(() => {
                          ...
                          context.updatedReceivedData();
                          context.notify(
                            `Welcome to Universe${name && ", " +name}. Start by adding posts to your account.`
                          );
                          props.history.push("/");
                        }, 150);
                      }
        ...
        <section className="auth--main flex-column">
            ...
            <div className="auth flex-column mt-5">
              <div className="auth--upper--card w-100 flex-column">
                <div className="auth--logo flex-row">
                  ...
                  <h1 className="logoText">Universe</h1>
                </div>
                <small className="insta--warning">
                  Note: this is not the official Universe website.
                </small>
                  ...
                  !signUpState ? (
                    ...
                    >
                      ...
                      <div className="signIn--options--box">
                        <SignInOption
                          method="anonymous"
                          methTitle="Log in without credentials just to experiment with the app. However, you may not get all the features Universe offers. Also, all your information will be public."
          ...
          <div className="auth--footer--container flex-row">
            ...
            <div className="auth--copyright flex-column flex-wrap">
              ...
              <span>
                &copy; {new Date().getFullYear()} Universe clone made by
                Prabesh Dahal
              </span>
            </div>
          </div>

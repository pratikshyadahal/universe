...
import HeaderLogoLight from "../../Assets/Universe-icon-logo.c1dbcbd5.svg";
import HeaderLogoDark from "../../Assets/Universe-icon-logo-loading.e195cbde.svg";
    ...
    <Auxiliary>
      ...
      <header ref={headerRef} id="header" className="main--header flex-row">
        <div className="header--inner flex-row">
          <div title="Universe" className="header--logo--box flex-row">
            <div style={{
              animation: "0.5s ease-in disappear-item 1",
            }}
              onClick={() => history.push("/")} className="ig--logo--img" >
              <img src={ (bodyCurrClass === "darkmode" || bodyCurrClass === "blueizis" || bodyCurrClass === "snorkelblue" || bodyCurrClass === "icedcoffee") ? HeaderLogoDark : HeaderLogoLight} alt="Universe Logo" />
            </div>
            <div style={{
